...
Use `-r n` or `--random n` to put n point randomly on the screen. Careful lot of point may cause trouble (more than 200/300).
...
Restart with `r` (it will restart with same arguments).
